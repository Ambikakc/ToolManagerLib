...
namespace ToolManagerLib
{
    ...
    {
        #region data member
        List<ToolOutputDataFormat> toolsOutputData= new List<ToolOutputDataFormat>();
        private IToolDataWriter toolDataCsvWriter;

        public IToolDataWriter ToolDataCsvWriter { get => toolDataCsvWriter; set => toolDataCsvWriter = value; }
        public List<ToolOutputDataFormat> ToolsOutputData { get => toolsOutputData; set => toolsOutputData = value; }
        #endregion
